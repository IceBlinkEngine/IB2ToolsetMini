...
namespace IB2ToolsetMini
{
    public partial class ContainerEditor : DockContent
    {
        ...
        IB2ToolsetMini.Container cte_container = new IB2ToolsetMini.Container();
        public ParentForm prntForm;

        public ContainerEditor(List<Item> items, IB2ToolsetMini.Container container, ParentForm p)
        {
            InitializeComponent();
            cte_itemsList = items;
